...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{MLOps} SageMaker Pipelines, MLFlow\\
     \textbf{Data Processing:} Spark, Pandas, Polars, NumPy \\
     \textbf{Developer Tools:} Git, Docker, Podman, PyCharm, Neovim \\
     \textbf{CI/CD for ML} GitHub Actions, AWS CDK, CloudFormation, Dagger.io
     \textbf{Model Deployment \& Monitoring} SageMaker, CloudWatch, Model Monitor
